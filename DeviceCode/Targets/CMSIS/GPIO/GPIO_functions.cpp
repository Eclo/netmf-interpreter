...
void GPIO_Interrupt0( void* param ) // EXTI0
{
    GPIO_ISR( 0 );
}

void GPIO_Interrupt1( void* param ) // EXTI1
{
    GPIO_ISR( 1 );
}

void GPIO_Interrupt2( void* param ) // EXTI2
{
    GPIO_ISR( 2 );
}

void GPIO_Interrupt3( void* param ) // EXTI3
{
    GPIO_ISR( 3 );
}

void GPIO_Interrupt4( void* param ) // EXTI4
{
    GPIO_ISR( 4 );
}

void GPIO_Interrupt5( void* param ) // EXTI5 - EXTI9
{
...
void GPIO_Interrupt10( void* param ) // EXTI10 - EXTI15
{
...
void GPIO_Pin_Config( GPIO_PIN pin, UINT32 mode, GPIO_RESISTOR resistor, UINT32 alternate )
{
