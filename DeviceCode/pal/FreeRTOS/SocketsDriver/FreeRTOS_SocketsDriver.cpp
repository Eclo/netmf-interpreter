...
{
    NATIVE_PROFILE_PAL_NETWORK();
    return FreeRTOS_SOCKETS_Driver::UpdateAdapterConfiguration(interfaceIndex, updateFlags, config);
}

HRESULT HAL_SOCK_CONFIGURATION_LoadWirelessConfiguration( UINT32 interfaceIndex, SOCK_WirelessConfiguration* wirelessConfig )
{
    NATIVE_PROFILE_PAL_NETWORK();
    return FreeRTOS_SOCKETS_Driver::LoadWirelessConfiguration(interfaceIndex, wirelessConfig);
}
