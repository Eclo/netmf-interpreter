...
// 		}
// 
// 		g_FreeRTOS_SOCKETS_Driver.m_interfaces[i].m_interfaceNumber = interfaceNumber;
// 
...
//     {
//         struct netif *pNetIf = netif_find_interface(g_FreeRTOS_SOCKETS_Driver.m_interfaces[0].m_interfaceNumber);
// 
...
//         struct netif *pNetIf;
// 
//         if (pNetIf = netif_find_interface(g_FreeRTOS_SOCKETS_Driver.m_interfaces[interfaceIndex].m_interfaceNumber))
//         {
...
//     BOOL fDhcpStarted;
// 
//     struct netif *pNetIf = netif_find_interface(g_FreeRTOS_SOCKETS_Driver.m_interfaces[interfaceIndex].m_interfaceNumber);
//     if (NULL == pNetIf)
//     {
//         return CLR_E_FAIL;
//     }
